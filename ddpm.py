...
class DDPMSampler:
    ...
    def set_inference_timesteps(self, num_inference_step = 50):
        self.num_inference_steps = num_inference_step
        step_ratio = self.num_training_steps // self.num_inference_steps
        timesteps = (np.arange(0, num_inference_step) * step_ratio).round()[::-1].copy().astype(np.int64)
